...
function Home() {
  ...
  const customStyle = {
    ...
    fontSize: "47px", // Taille de police personnalisée
  };
  return (
    <>
      <div className="w-full pt-32 pl-7 flex">
        <div className="w-[50%] space-y-7 ">
          ...
          <div className="flex space-x-4">
            <button className="p-4 rounded-md text-[#fff]  font-bold bg-gradient-to-r from-[#D4145A] to-[#FBB03B]">Votre economie ici</button>
            <button className="text-[#fff] rounded-md border-[1px] border-[#FBB03B] p-4">Contact Us</button>
          </div>
        </div>
        <div></div>
      </div>
